                ...
                for (int k = 0; k != numberOfChannels; ++k) {
                    ...
                    // ===================
                    {
                        ...
                        for (int n = 0; n != numberOfChannels; ++n)
                            weightedSum += channelWeighting[n] * averageOfTheLast3s[n];
                    ...
                    // ==================
                    {
                        ...
                        for (int n = 0; n != int(averageOfTheLast400ms.size()); ++n)
                            weightedSum += channelWeighting[n] * averageOfTheLast400ms[n];
