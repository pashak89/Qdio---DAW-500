...
//    on_Tf3Changed: if(inTrack | inAutomationMenu) {tfPan3.value = tf3; tfPan3.text = tfPan3.value}
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                trackAudioModel.setProperty(ind, 'automationChildren', automationList.count)
            }
        }
    }
    ...
    states: [State {
            ...
            PropertyChanges {
                ...
                anchors.rightMargin: trackAudioModel.get(ind).automationList.count -1 === index ? draggableSize : 0
        ...
        State {
            ...
            PropertyChanges {
                ...
                anchors.leftMargin: trackAudioModel.get(ind).automationList.count -1 === index ? draggableSize : 0
            }
