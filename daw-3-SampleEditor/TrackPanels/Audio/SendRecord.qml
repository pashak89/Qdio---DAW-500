...
Rectangle {
    ...
    RowLayout {
        ...
        TrackSubButton {
            ...
            flColor: selectedTrack  ? (isClicked ? '#DE3C47' : 'transparent') : isClicked ? '#DE3C47' : theme.s11_Enable_FIL
            ...
            ColorOverlay {
                ...
                //                    clip:                   true
                //                    antialiasing:           true
                color:                  recordBtn.isClicked | selectedTrack   ? theme.a1 : theme.a2
            }
            //                MouseArea {
            //                    anchors.fill: parent
        ...
        TrackSubButton {
            ...
            Layout.fillHeight:      true
            Layout.fillWidth:       true
            flColor: selectedTrack   ? (isClicked ? '#13C44B' : 'transparent') : isClicked ? '#13C44B' : theme.s11_Enable_FIL
            ...
            ColorOverlay {
                ...
                clip:                   true
                antialiasing:           true
                color:                  sendBtn.isClicked | selectedTrack   ? theme.a1 : theme.a2
            }
            //                MouseArea {
            //                    anchors.fill: parent
