...
//    on_Tf3Changed: if(inTrack | inAutomationMenu) {tfPan3.value = tf3; tfPan3.text = tfPan3.value}
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                trackReturnModel.get(ind).automationList.remove(index, 1)
    ...
    states: [State {
            ...
            PropertyChanges {
                ...
                anchors.rightMargin: trackReturnModel.get(ind).automationList.count -1 === index ? draggableSize : 0
        ...
        State {
            ...
            PropertyChanges {
                ...
                anchors.leftMargin: trackReturnModel.get(ind).automationList.count -1 === index ? draggableSize : 0
            }
