...
namespace DGE
{
	namespace GFX
	{
		namespace GCore
		{
			namespace GL
			{
				class BaseTextureGL : public DGE::GFX::GCore::BaseTexture
				{
				public:
					/// \brief Constructor for BaseTexture that need renderer as input parameter
					///
					/// \param renderer shared pointer to GFX::GL::RendererGL class.
					BaseTextureGL(std::shared_ptr<GFX::GCore::GL::RendererGL> renderer);
				...
				protected:
					...
					/// \brief Store texture ID from glGenBuffers
					uint32 m_textureID;
				};
