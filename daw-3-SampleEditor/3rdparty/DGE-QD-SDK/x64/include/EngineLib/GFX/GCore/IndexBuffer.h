...
namespace DGE
{
	namespace GFX
	{
		namespace GCore
		{
			/// \brief Abstract base class for index buffer
			class IndexBuffer : public GFX::GCore::Interfaces::IGpuBuffer
			{
			public:
				...
				ElementDrawInfo elementDrawInfo(
			...
			using IndexBufferRef = std::shared_ptr<GFX::GCore::IndexBuffer>;
			using IndexBufferWRef = std::weak_ptr<GFX::GCore::IndexBuffer>;
		} // namespace GCore
	}	  // namespace GFX
} // namespace DGE
