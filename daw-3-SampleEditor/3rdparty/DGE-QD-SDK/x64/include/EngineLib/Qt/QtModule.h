...
namespace DGE
{
	...
	{
		/// \brief Qt Module
		class DGE_QtAPI QtModule
			: public DGE::Core::System::DModule
			, public Core::Utility::Singleton<QtModule>
		{
			D_OBJECT_SINGLETON(QtModule)
			QtModule(std::shared_ptr<Core::System::Context> context
		...
		using QtModuleRef = std::shared_ptr<QtModule>;
