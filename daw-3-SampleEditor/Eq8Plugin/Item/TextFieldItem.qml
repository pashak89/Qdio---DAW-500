...
TextInput {
    ...
    property real lineW: 3 //mainRoot_id.refSize
    ...
    font.family: thisFont.name //fontFamilty
    ...
    onTextChanged: {
        ...
        if (text * 1 === defaultValue || value === defaultValue)
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            height: 2 //mainRoot_id.topWidth === 1 ? 2 : mainRoot_id.topWidth
            color: //envelopeBtn.isClicked ? theme.s21_on :
                   theme.s20_off
            anchors {
                left: parent.left
    ...
    MouseArea {
        ...
        onPressed: {
            ...
            cursorPositionClass.saveCursorPos(globalPosition.x, globalPosition.y)
        ...
        onMouseYChanged: {
            ...
            if (isSlider) {
                ...
                if (mouse.y > 60)
                    cursorPositionClass.moveCursor(60)
            } else {
                ...
                value = innerTempo ? Math.round(
                                         y_pos
                                         / scaleY) : isTempo ? roundToTenth(
                                                                   y_pos / scaleY) : y_pos / scaleY
    ...
    Rectangle {
        ...
        color: 'transparent'
        border.color: isSlider ? 'transparent' : brColor
        border.width: Math.min(Math.round(/*mainRoot_id.topWidth*/ 3) * 2, 2)
        anchors.margins: -1
